...
interface AgentRegisterQuerySchedulingFinishSchedulingProps {
  uid: string;
  AgentRegisterQueryScheduling: AgentRegisterQueryScheduling;
}

export function AgentRegisterQuerySchedulingFinishScheduling({
  uid,
  AgentRegisterQueryScheduling,
}: AgentRegisterQuerySchedulingFinishSchedulingProps) {
